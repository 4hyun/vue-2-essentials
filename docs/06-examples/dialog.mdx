...
> 여기서 **Poup,Dialog 호출** 은 b-modal show 하는것을 의미합니다.
...
해결 제안인 `showDialogV2`는 다음을 수행합니다:

- 1 Dialog 를 1 곳만 등록할수있고(예: Application Root, Application Shell(eg. LayoutComponent))
  - event 관리는 Dialog component 의 custom option 로 등록해서 관리하게끔 하며.
